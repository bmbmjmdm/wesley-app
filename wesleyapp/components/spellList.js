...
export default [
    {targetWord: "dog", pic: dogPic},
    {targetWord: "park", pic: parkPic},
    {targetWord: "reading", pic: readingPic},
    {targetWord: "apple", pic: applePic},
    {targetWord: "flowers", pic: flowersPic},
    {targetWord: "clouds", pic: cloudsPic},
    {targetWord: "cat", pic: catPic},
    {targetWord: "grandma", pic: grandmaPic},
    {targetWord: "smile", pic: smilePic},
    {targetWord: "sheep", pic: sheepPic},
    {targetWord: "dad", pic: dadPic},
    {targetWord: "kitten", pic: kittenPic},
    {targetWord: "tower", pic: towerPic},
    {targetWord: "tree", pic: treePic},
]